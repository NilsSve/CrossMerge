...
Object oRdcView is a dbView
    ...
    Object oDataTableConnectionTop_grp is a cRDCHeaderDbGroup
        ...
        Set Label to "Header Info"
        Set psNote to "Database connections"
        Set psImage to "DbConnections2.ico"
    ...
    Object oDbTables_td is a dbTabDialog
        ...
        Object oDatabaseTables_tp is a dbTabPage
            ...
            Object oFromDatabase_grp is a cRDCHeaderDbGroup
                ...
                Set peAnchors to anTopLeftRight
                Set psLabel to "Source Table"
                Set psNote to "Select From database table"
                Set psImage to "DatabaseSource2.ico"
...
//                End_Object
            ...
            Object oToDatabase_grp is a cRDCHeaderDbGroup
                Set Size to 122 497
                Set Location to 143 7
                Set psLabel to "Target Table"
                Set psNote to "Select To database table"
                Set psImage to "DatabaseTarget2.ico"
                Set peAnchors to anAll
                ...
                Object oSnctable_ToDbType is a cDbComboformDataFormat
                    ...
                    Procedure Refresh Integer iNotifyMode
                        ...
                        Set Enabled_State of (oSnctable_ToFileOEMToANSI(Self)) to (iDbType <> EN_DbTypeDataFlex)
                    End_Procedure
        ...
        Object oFields_tp is a dbTabPage
            ...
            Object oFromDataTable_fm is a cRDCDbForm
                Entry_Item SncTable.FromDataTable
            ...
            Object oToDataTable_fm is a cRDCDbForm
                Entry_Item Snctable.ToDataTable
            ...
            Object oMatchingFields_grp is a cRDCHeaderDbGroup
                ...
                Object oFieldNames_grd is a cCJGrid
                    ...
                    Procedure Delete_Data  
                        ...
                        End
                        Send ResetGrid  
                        Set psFooterText of oSourceFieldName_col to ("No of Matching Fields:")
...
//                        Get WinCombo_Value Item iItem  to sMode
                ...
                Object oDeleteValueTable_bn is a cRDCButton
                    Set Label to "D&elete Filter"
                    Set Size to 14 60
                    Set Location to 73 415
            ...
            Object oSnctable_FromdataTable_Filter is a cRDCDbForm
                Entry_Item Snctable.FromDataTable
            ...
            Object oViewFromData_bn is a cViewDataButton
                ...
                Procedure OnClick
                    ...
                    If (Length(sRetval) > 0) Begin
                        Set Value of oValue_fm to sRetval
                    End
                End_Procedure
            End_Object
        ...
        Object oNulls_tp is a dbTabPage
            ...
            Object oNullDefaults_grp is a cRDCHeaderDbGroup
                ...
                Object oDefaults_grp is a dbGroup
                    ...
                    Set Label to "Use Default Values"
                    Set peAnchors to anTopBottom
                ...
                Object oValues_grd is a cCJGrid
                    ...
                    Object oDefinedDefault_Col is a cCJGridColumn
                        ...
                        Set TextColor to clDkGray
                        Set pbDrawHeaderDivider to False
                        Set psToolTip to "Standard defaults specified by the database driver or database backend"
                    End_Object
            ...
            Object oSnctable_TodataTable_Null is a cRDCDbForm
                Entry_Item Snctable.Todatatable
                Set Label to "Target Table Name"
                Set Size to 14 150
                Set Location to 15 8
        ...
        Object oValueConversion_tp is a dbTabPage
            ...
            Object oSnctable_FromdataTable_Conv is a cRDCDbForm
                Entry_Item SncTable.FromDataTable
                Set Label to "Source Table Name"
                Set Size to 14 150
                Set Location to 15 8
            ...
            Object oSnctable_TodataTable_Conv is a cRDCDbForm
                Entry_Item SncTable.ToDataTable
                Set Label to "Target Table Name"
                Set Size to 14 150
        ...
        Object oMarkSourceRows_tp is a dbTabPage
            ...
            Object oSncTable_FromDataTable_Mark is a cRDCDbForm
                Entry_Item SncTable.FromDataTable
                Set Label to "Source Table Name"
                Set Size to 14 150
                Set Location to 15 8
            ...
            Object oViewFromData_bn is a cViewDataButton
                ...
                Procedure OnClick
                    ...
                    Get msg_DoViewData True iItem to sRetval
                    If (Length(sRetval) > 0) Begin
                        Set Value of oValueFunction_cf to sRetval
                    End
                End_Procedure
    ...
    Procedure Request_Save
        Boolean bSave
        Forward Send Request_Save
        Get Should_Save of (oSncSys_DD(Self)) to bSave
        If (bSave = True) Begin
            Send Request_Save of (oSncsys_DD(Self))
        End
    End_Procedure
    ...
    Function DisplayDeleteWaring Returns Boolean
        Integer iRetval
        Get YesNo_Box "Are you sure you want to Delete this connection record?" to iRetval
        Function_Return (iRetval <> MBR_YES)
    End_Function

    Set Verify_Delete_msg to (RefFunc(DisplayDeleteWaring))
